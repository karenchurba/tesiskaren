...
# Resumen: Este script carga los datos fenotípicos y de metilación, realiza la normalización y un 
#          filtrado de CpGs (por detección, SNPs, variabilidad y relevancia funcional). 
#          Luego, genera visualizaciones iniciales y guarda los resultados procesados en un archivo RData para su uso posterior.
#Input: Tesis
#Output: qcReport.pdf , preprocesado.RData (datos_fenotípicos + Matriz_Met_Flt + mSetSqFlt + annEPIC)
#Author: karenchurba
...
#---1.2. Librerías--------------------------------------------------------------
#hacer un for: hacer una lista de todas las librerías y para cada elemto de la lista carga la librería (si está instalado, sino lo instala tmb)#
...
save(datos_fenotipicos, Matriz_met_Flt, mSetSqFlt, annEPIC, file = "preprocesado.RData")
